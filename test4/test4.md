...
![image-20210426175449262](image-20210426175449262.png)

### 2. 使用系统用户创建表空间 Users17

![UTOOLS-CLIPBOARD-1619431652374](UTOOLS-CLIPBOARD-1619431652374.png)

### 3.查看文件夹

![image-20210426180824879](image-20210426180824879.png)

### 4.给用户 user1 授予表空间 Users17 的使用权限

![image-20210426181019326](image-20210426181019326.png)

### 5.删除表和序列

![image-20210426181141679](image-20210426181141679.png)

### 6.创建表 DEPARTMENTS、EMPLOYEES、PRODUCTS、ORDER_ID_TEMP、ORDERS

![image-20210426181316508](image-20210426181316508.png)

![UTOOLS-CLIPBOARD-1619432041370](UTOOLS-CLIPBOARD-1619432041370.png)

### 7.创建本地分区索引 ORDERS_INDEX_DATE

![image-20210426181543033](image-20210426181543033.png)

![UTOOLS-CLIPBOARD-1619432208828](UTOOLS-CLIPBOARD-1619432208828-1619432239707.png)

### 8.创建三个触发器

![image-20210426181816558](image-20210426181816558.png)

### 9.插入数据

插入数据前禁用触发器

![image-20210426181915579](image-20210426181915579.png)

![image-20210426182013402](image-20210426182013402.png)

## 测试

### 1.普通查询

![image-20210426182307395](image-20210426182307395.png)

![image-20210426182319911](image-20210426182319911.png)

![image-20210426182330464](image-20210426182330464.png)

### 2.递归查询某个员工及其所有下属，子下属员工

![image-20210426182425175](image-20210426182425175.png)

### 3.特殊查询语句

- 查询分区表

![image-20210426182520012](image-20210426182520012.png)

- 查询分区索引

![image-20210426182554576](image-20210426182554576.png)

### 4.查询一个分区中的数据

![image-20210426182917634](image-20210426182917634.png)

![image-20210426182933395](image-20210426182933395.png)

### 5.查询表的统计信息

![image-20210426183033097](image-20210426183033097.png)

### 6.查看文件使用情况

![image-20210426183059355](image-20210426183059355.png)

### 7.查询表空间的使用情况

![image-20210426183221115](image-20210426183221115.png)